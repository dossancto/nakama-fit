...
maleslc.addEventListener("click", turnOff("male"));
femaleslc.addEventListener("click", turnOff("female"))

function turnOff(sex){
  
  if (sex === "male"){
    femaleslc.checked = false;
  }
  else{
    maleslc.checked = false;
  }
}